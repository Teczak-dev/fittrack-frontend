...
export const VerifyAccountLayout: React.FC<{message:string}> = ({message}) => {
	...
	<div className={styles.container} style={containerStyle}>
	    ...
	    <div style={{ maxWidth: 400, margin: '3rem auto', textAlign: 'center', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
