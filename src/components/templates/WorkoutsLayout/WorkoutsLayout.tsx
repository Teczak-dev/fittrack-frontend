  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <Button
          variant="primary"
          className={` ${styles.addWorkoutBtn} ${btnTheme}`}
      ...
      {workouts.length === 0 && (
        <div style={{ width: "100%", textAlign: "center", marginTop: "50px" }}>
          <Typography variant="body" className={styles.noWorkoutsMessage}>
            Nie masz jeszcze żadnych zapisanych ćwiczeń. Dodaj swój pierwszy
            trening, klikając przycisk "+" powyżej.
          </Typography>
        </div>
      )}
