...
export const BannerHP: React.FC = () => {
  ...
  const appNameTextColor: string =
    theme === "light"
      ? styles.appNameTextColorLight
      : styles.appNameTextColorDark;
  const imageTheme: string =
    theme === "light" ? styles.imageLight : styles.imageDark;
  const subtextColor: string =
    theme === "light" ? styles.subtextColorLight : styles.subtextColorDark;
  ...
  return (
    <div className={styles.banner}>
      ...
      <Image
        src={bannerImg}
        alt="Banner Image"
        className={`${styles.bannerImage} ${imageTheme}`}
      />
    </div>
  );
};
