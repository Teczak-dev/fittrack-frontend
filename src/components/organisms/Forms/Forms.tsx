...
export const RegisterForm: React.FC<RegisterFormProps> = ({
  ...
  return (
    <div className={` ${styles.loginForm} ${loginFormThemeColor} `}>
      ...
      <Typography variant="body" className={styles.loginText}>
        Masz konto?{" "}
        <Link url="/login" text="Zaloguj się" className={styles.loginLink} />
      </Typography>
    </div>
  );
};
...
export const ForgotPasswordForm: React.FC<ForgotPasswordFormProps> = ({
  ...
  return (
    <div className={` ${styles.loginForm} ${loginFormThemeColor} `}>
      <Typography variant="body" className={styles.loginBack}>
        <Link
          url="/login"
...
export const ResetPasswordForm: React.FC<ResetPasswordFormProps> = ({
  ...
  const {
    ...
    handleSubmit,
  } = useResetPasswordForm(handleReset);
